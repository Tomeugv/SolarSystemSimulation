...
public class PlanetAdminServlet extends HttpServlet {
    ...
    private static final String DB_USER = "your_username";  // <-- Replace if needed
    private static final String DB_PASSWORD = "your_password"; // <-- Replace if needed
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try (Connection conn = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD);
            ...
            ps.setDouble(7, perihelionDistance); // Correct x = perihelion
    ...
    protected void doDelete(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try (Connection conn = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD);
            ...
            // Reload simulation state after delete too
            SimulationState state = (SimulationState) getServletContext().getAttribute("simulationState");
            if (state != null) {
                state.reload();
            }
